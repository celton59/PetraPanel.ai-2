...
import { Clock, Edit, PlayCircle, Youtube, AlertCircle, Image } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
  ...
  function renderCardContent () {
    switch (video.status) {
      ...
      case 'media_corrections':
        return <MediaCorrectionsContent
            video={video}
            onUpdate={onUpdate}
          />
      case 'youtube_ready':
        return <YoutubeReadyContent video={video} />;
      case 'review':
