              ...
              {selectMode ? (
                <div className="flex items-center gap-2">
                  ...
                  <div className="relative ml-1 group">
                    ...
                    <div className="absolute hidden group-hover:block right-0 top-full mt-2 z-50 bg-card shadow-lg rounded-lg border p-3 w-[280px] animate-in fade-in-50 zoom-in-95">
                      <div className="text-xs text-muted-foreground">
